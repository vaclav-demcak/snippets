...
import vd.samples.springboot.statemachine.state.OrderStatusChangeEventEnum;
import vd.samples.springboot.statemachine.state.OrderStatusEnum;

import java.util.EnumSet;

/**
 * @apiNote : order statemachine
 */
@Configuration
@EnableStateMachine
