...
public class AmqpNotifQueueListener implements MessageListener, ExceptionListener, Closeable {

  private static final Logger LOG = LoggerFactory.getLogger(AmqpNotifQueueListener.class);
  ...
  public AmqpNotifQueueListener(IAmqpProperties prop) throws JMSException {
    ...
    Destination destination = session.createQueue(prop.getJmsNotifQueue());
