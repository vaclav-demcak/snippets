...
public interface MessageApi {
  ...
  @ApiOperation(value = "Returns param", nickname = "applicationInformation", notes = "Returns param", response = String.class)
  @ApiResponses(value = {
      @ApiResponse(code = 200, message = "Successful retrieval of app Info", response = String.class) })
  @RequestMapping(value = "/app-info",
      produces = { "application/json" },
      method = RequestMethod.GET)
  default ResponseEntity<String> applicationInformation() {
