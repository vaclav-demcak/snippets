package vd.sandbox.spring.openapi.citrus.comp;
...
//@Component
//@EnableScheduling
public class SchedulerTasksComponent {

  private static final Logger LOG = LoggerFactory.getLogger(SchedulerTasksComponent.class);
